# Agent 11-poster — SKILL (Builder owns this file)

**Builder:** TBD
**Reviewer:** TBD
**Default product:** shulex-cn
**Status:** blocked
...
- `engines/shulex-cn/` Skill Graph (Ronin pattern)
- `memory/playbook.md` cross-agent lessons
- `agents/11-poster/playbook.md` agent-specific lessons
- `agents/11-poster/anti-patterns.md` rejected drafts

## Tools / platform connectors
TODO — list `platforms/*` modules.

## Execution recipe
1. Read `engines/shulex-cn/CLAUDE.md` for full skill graph
2. Read `agents/11-poster/playbook.md` + `anti-patterns.md`
3. Produce native draft (NOT reformat — rethink per Principle 5)
4. Write to `agents/11-poster/content-bank/draft/<ts>-<slug>.md` with frontmatter (product, topic, hook_type, source_url)
