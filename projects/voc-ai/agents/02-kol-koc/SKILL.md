# Agent 02-kol-koc — SKILL (Builder owns this file)
...
- `agents/02-kol-koc/playbook.md` agent-specific lessons
- `agents/02-kol-koc/anti-patterns.md` rejected drafts
...
2. Read `agents/02-kol-koc/playbook.md` + `anti-patterns.md`
3. Produce native draft (NOT reformat — rethink per Principle 5)
4. Write to `agents/02-kol-koc/content-bank/draft/<ts>-<slug>.md` with frontmatter (product, topic, hook_type, source_url)
5. Symlink into `reviews/Ivy/` for queue
